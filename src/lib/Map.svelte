...
<div class="svg-container md:absolute md:bottom-[4.5rem] relative bottom-40 right-2 z-0  " on:click={()=> changeZone = !changeZone}>
    {#if changeZone}
...
<button on:click={() => changeStyle()} class="md:absolute bottom-28 relative md:bottom-6 right-2 z-0">
    <ThemeSwitch/>
</button>
